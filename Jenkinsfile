pipeline {
    ...
    environment {
        FRONTEND_REPO = 'prawinkumar22/frontend-app'
        BACKEND_REPO  = 'prawinkumar22/backend-app'
    ...
    stages {
        ...
        stage('Checkout Code') {
            steps {
                git branch: 'master', url: 'https://github.com/PrawinKumar22/jenkins-demo-latest.git'
            }
        }
